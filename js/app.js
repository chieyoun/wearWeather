const API_KEY = "29e61e4b95435112b01e4df924dcf763"; //add your API KEY 
...
function handleError() {
    ...
    weatherInfo.innerText = '위치정보를 얻을 수 없습니다.'
}
...
function getWeather(lat, lon) {
    ...
    .then(function(json) {
        ...
        //받아온 정보들을 표현한다. 
        weatherInfo.innerText = `${Math.round(temperature * 10) / 10} °C / 위치: ${place} / ${weatherDescription}`;
